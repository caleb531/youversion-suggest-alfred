...
@use_prefs({'language': 'en', 'version': 111, 'search_engine': 'duckduckgo'})
@patch('webbrowser.open')
...
@use_prefs({'language': 'en', 'version': 111, 'search_engine': 'xyz'})
@patch('webbrowser.open')
...
@use_prefs({'language': 'es', 'version': 128, 'search_engine': 'google'})
@patch('webbrowser.open')
