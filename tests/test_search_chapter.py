...
def test_basic():
    ...
    nose.assert_equal(results[0]['title'], 'Matthew 5')
...
def test_ambiguous():
    ...
    nose.assert_equal(results[0]['title'], 'Amos 3')
    nose.assert_equal(results[1]['title'], 'Acts 3')
...
def test_whitespace():
    ...
    nose.assert_equal(len(results), 1)
    nose.assert_equal(results[0]['title'], '1 Peter 5')
