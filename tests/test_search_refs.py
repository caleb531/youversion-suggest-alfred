...
def test_copy_by_default_false():
    ...
    case.assertEqual(results[0]["subtitle"], "» “Lorem ipsum” dolor sit amet,")
    case.assertEqual(results[0]["mods"]["cmd"]["subtitle"], "Copy content to clipboard")
...
def test_copy_by_default_true():
    ...
    case.assertEqual(results[0]["subtitle"], "» “Lorem ipsum” dolor sit amet,")
    case.assertEqual(results[0]["mods"]["cmd"]["subtitle"], "View on YouVersion")
